...
const PoliticaPrivacidade = () => {
  ...
  return (
    <>
      <Head
        metaDescription="Política de Privacidade | Guardar Dinheiro"
        title="Política de Privacidade | Guardar Dinheiro"
        h1="Política de Privacidade | Guardar Dinheiro"
        canonical="https://www.guardardinheiro.com.br/politica-privacidade"
      />
      ...
      />
      <Container>
        <H2 texto="A sua privacidade é importante para nós" />

        <Paragrafo texto="É política do Guardar Dinheiro respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Guardar Dinheiro, e outros sites que possuímos e operamos." />
        ...
        <H3 texto="- Política de Cookies Guardar Dinheiro" />
        <Paragrafo
          texto=" 
        O que são cookies? Como é prática comum em quase todos os sites
        profissionais, este site usa cookies, que são pequenos arquivos baixados
        no seu computador, para melhorar sua experiência. Esta página descreve
        quais informações eles coletam, como as usamos e por que às vezes
        precisamos armazenar esses cookies. Também compartilharemos como você
        pode impedir que esses cookies sejam armazenados, no entanto, isso pode
        fazer o downgrade ou 'quebrar' certos elementos da funcionalidade do
        site."
        />
        <Paragrafo
          texto="
        ...
        você usa. Desativar cookies Você pode impedir a configuração de cookies
        ajustando as configurações do seu navegador (consulte a Ajuda do
        navegador para saber como fazer isso). Esteja ciente de que a
        desativação de cookies afetará a funcionalidade deste e de muitos outros
        sites que você visita. A desativação de cookies geralmente resultará na
        desativação de determinadas funcionalidades e recursos deste site.
        Portanto, é recomendável que você não desative os cookies. Cookies que
        definimos Cookies relacionados à conta Se você criar uma conta connosco,
        ...
        inscritos. Pedidos processando cookies relacionados Este site oferece
        ...
        também usamos cookies fornecidos por terceiros confiáveis."
        />
        <br></br>

        <b>
          <H3 texto="- Política de Cookies de Terceiros" />
        </b>
        <Paragrafo
          texto="
        Esta seção detalha quais cookies de terceiros você pode encontrar
        ...
        <Paragrafo
          texto="
        Esses cookies podem rastrear itens como quanto tempo você gasta no site
        e as páginas visitadas, para que possamos continuar produzindo conteúdo
        ...
        entendemos quais otimizações os nossos usuários mais apreciam. À medida
        que vendemos produtos, é importante entendermos as estatísticas sobre
        quantos visitantes de nosso site realmente compram e, portanto, esse é o
        tipo de dados que esses cookies rastrearão. Isso é importante para você,
        pois significa que podemos fazer previsões de negócios com precisão que
        ...
        <H3 texto="- Compromisso do Usuário" />
        <Paragrafo
          texto="
        O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o Guardar Dinheiro oferece no site e com caráter
        ...
        ou sobre cassinos, apostas desportivas (ex.: Betano), jogos de sorte e
        azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou
        contra os direitos humanos;"
        />
        <Paragrafo
          texto="
        C) Não causar danos aos sistemas físicos (hardwares) e lógicos
        (softwares) do Guardar Dinheiro, de seus fornecedores ou terceiros, para
